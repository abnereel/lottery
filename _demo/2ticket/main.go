...
func (c *lotterController) Get() string {
	...
	case code >= 4 && code <= 6:
		prize = "三等奖"
	default:
		return fmt.Sprintf("尾号为1获得一等奖<br/>尾号为2或者3获得二等奖<br/>尾号为4/5/6获得三等奖<br/>code=%d<br/>很遗憾，没有获奖", code)
	}
	return fmt.Sprintf("尾号为1获得一等奖<br/>尾号为2或者3获得二等奖<br/>尾号为4/5/6获得三等奖<br/>code=%d<br/>恭喜你获得:%s", code, prize)
}
