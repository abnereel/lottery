...
type LuckyService interface {
	...
	//  - App
	//  - Sign
	DoLuck(ctx context.Context, uid int64, username string, ip string, now int64, app string, sign string) (r *DataResult_, err error)
	// Parameters:
	//  - UID
	//  - Username
	//  - IP
...
//  - App
//  - Sign
func (p *LuckyServiceClient) DoLuck(ctx context.Context, uid int64, username string, ip string, now int64, app string, sign string) (r *DataResult_, err error) {
	var _args0 LuckyServiceDoLuckArgs
	_args0.UID = uid
	...
	_args0.App = app
	_args0.Sign = sign
	var _result1 LuckyServiceDoLuckResult
	if err = p.Client_().Call(ctx, "DoLuck", &_args0, &_result1); err != nil {
		return
	}
...
func NewLuckyServiceProcessor(handler LuckyService) *LuckyServiceProcessor {
	...
	self4.processorMap["DoLuck"] = &luckyServiceProcessorDoLuck{handler: handler}
...
type luckyServiceProcessorDoLuck struct {
	handler LuckyService
}

func (p *luckyServiceProcessorDoLuck) Process(ctx context.Context, seqId int32, iprot, oprot thrift.TProtocol) (success bool, err thrift.TException) {
	args := LuckyServiceDoLuckArgs{}
	if err = args.Read(iprot); err != nil {
		iprot.ReadMessageEnd()
		x := thrift.NewTApplicationException(thrift.PROTOCOL_ERROR, err.Error())
		oprot.WriteMessageBegin("DoLuck", thrift.EXCEPTION, seqId)
		x.Write(oprot)
		oprot.WriteMessageEnd()
		oprot.Flush(ctx)
		return false, err
	...
	iprot.ReadMessageEnd()
	result := LuckyServiceDoLuckResult{}
	var retval *DataResult_
	var err2 error
	if retval, err2 = p.handler.DoLuck(ctx, args.UID, args.Username, args.IP, args.Now, args.App, args.Sign); err2 != nil {
		x := thrift.NewTApplicationException(thrift.INTERNAL_ERROR, "Internal error processing DoLuck: "+err2.Error())
		oprot.WriteMessageBegin("DoLuck", thrift.EXCEPTION, seqId)
		x.Write(oprot)
		oprot.WriteMessageEnd()
		oprot.Flush(ctx)
	...
	if err2 = oprot.WriteMessageBegin("DoLuck", thrift.REPLY, seqId); err2 != nil {
		err = err2
	}
...
//  - App
//  - Sign
type LuckyServiceDoLuckArgs struct {
...
func NewLuckyServiceDoLuckArgs() *LuckyServiceDoLuckArgs {
	return &LuckyServiceDoLuckArgs{}
}

func (p *LuckyServiceDoLuckArgs) GetUID() int64 {
	return p.UID
}

func (p *LuckyServiceDoLuckArgs) GetUsername() string {
	return p.Username
}

func (p *LuckyServiceDoLuckArgs) GetIP() string {
	return p.IP
}

func (p *LuckyServiceDoLuckArgs) GetNow() int64 {
	return p.Now
}

func (p *LuckyServiceDoLuckArgs) GetApp() string {
	return p.App
}

func (p *LuckyServiceDoLuckArgs) GetSign() string {
	return p.Sign
}
func (p *LuckyServiceDoLuckArgs) Read(iprot thrift.TProtocol) error {
	if _, err := iprot.ReadStructBegin(); err != nil {
		return thrift.PrependError(fmt.Sprintf("%T read error: ", p), err)
	}
...
func (p *LuckyServiceDoLuckArgs) ReadField1(iprot thrift.TProtocol) error {
	if v, err := iprot.ReadI64(); err != nil {
		return thrift.PrependError("error reading field 1: ", err)
	} else {
		p.UID = v
...
func (p *LuckyServiceDoLuckArgs) ReadField2(iprot thrift.TProtocol) error {
	if v, err := iprot.ReadString(); err != nil {
		return thrift.PrependError("error reading field 2: ", err)
	} else {
		p.Username = v
...
func (p *LuckyServiceDoLuckArgs) ReadField3(iprot thrift.TProtocol) error {
	if v, err := iprot.ReadString(); err != nil {
		return thrift.PrependError("error reading field 3: ", err)
	} else {
		p.IP = v
...
func (p *LuckyServiceDoLuckArgs) ReadField4(iprot thrift.TProtocol) error {
	if v, err := iprot.ReadI64(); err != nil {
		return thrift.PrependError("error reading field 4: ", err)
	} else {
		p.Now = v
...
func (p *LuckyServiceDoLuckArgs) ReadField5(iprot thrift.TProtocol) error {
	if v, err := iprot.ReadString(); err != nil {
		return thrift.PrependError("error reading field 5: ", err)
	} else {
		p.App = v
...
func (p *LuckyServiceDoLuckArgs) ReadField6(iprot thrift.TProtocol) error {
	if v, err := iprot.ReadString(); err != nil {
		return thrift.PrependError("error reading field 6: ", err)
	} else {
		p.Sign = v
...
func (p *LuckyServiceDoLuckArgs) Write(oprot thrift.TProtocol) error {
	if err := oprot.WriteStructBegin("DoLuck_args"); err != nil {
		return thrift.PrependError(fmt.Sprintf("%T write struct begin error: ", p), err)
	}
	if p != nil {
		if err := p.writeField1(oprot); err != nil {
...
func (p *LuckyServiceDoLuckArgs) writeField1(oprot thrift.TProtocol) (err error) {
...
func (p *LuckyServiceDoLuckArgs) writeField2(oprot thrift.TProtocol) (err error) {
...
func (p *LuckyServiceDoLuckArgs) writeField3(oprot thrift.TProtocol) (err error) {
...
func (p *LuckyServiceDoLuckArgs) writeField4(oprot thrift.TProtocol) (err error) {
...
func (p *LuckyServiceDoLuckArgs) writeField5(oprot thrift.TProtocol) (err error) {
...
func (p *LuckyServiceDoLuckArgs) writeField6(oprot thrift.TProtocol) (err error) {
...
func (p *LuckyServiceDoLuckArgs) String() string {
	if p == nil {
		return "<nil>"
	}
	return fmt.Sprintf("LuckyServiceDoLuckArgs(%+v)", *p)
}

// Attributes:
//  - Success
type LuckyServiceDoLuckResult struct {
	Success *DataResult_ `thrift:"success,0" db:"success" json:"success,omitempty"`
}

func NewLuckyServiceDoLuckResult() *LuckyServiceDoLuckResult {
	return &LuckyServiceDoLuckResult{}
}

var LuckyServiceDoLuckResult_Success_DEFAULT *DataResult_

func (p *LuckyServiceDoLuckResult) GetSuccess() *DataResult_ {
	if !p.IsSetSuccess() {
		return LuckyServiceDoLuckResult_Success_DEFAULT
	}
	return p.Success
}
func (p *LuckyServiceDoLuckResult) IsSetSuccess() bool {
	return p.Success != nil
}

func (p *LuckyServiceDoLuckResult) Read(iprot thrift.TProtocol) error {
	if _, err := iprot.ReadStructBegin(); err != nil {
		return thrift.PrependError(fmt.Sprintf("%T read error: ", p), err)
	}
...
func (p *LuckyServiceDoLuckResult) ReadField0(iprot thrift.TProtocol) error {
...
func (p *LuckyServiceDoLuckResult) Write(oprot thrift.TProtocol) error {
	if err := oprot.WriteStructBegin("DoLuck_result"); err != nil {
		return thrift.PrependError(fmt.Sprintf("%T write struct begin error: ", p), err)
	}
	if p != nil {
...
func (p *LuckyServiceDoLuckResult) writeField0(oprot thrift.TProtocol) (err error) {
	if p.IsSetSuccess() {
...
func (p *LuckyServiceDoLuckResult) String() string {
	if p == nil {
		return "<nil>"
	}
	return fmt.Sprintf("LuckyServiceDoLuckResult(%+v)", *p)
}
